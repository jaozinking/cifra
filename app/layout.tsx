...
export const metadata: Metadata = {
  ...
  description: 'Платформа для продажи цифровых товаров. Создавайте, продавайте и монетизируйте свои цифровые продукты: шаблоны, дизайны, код, электронные книги и многое другое.',
  keywords: ['цифровые товары', 'digital products', 'продажа файлов', 'шаблоны', 'дизайн', 'электронные книги'],
  authors: [{ name: 'Cifra' }],
  creator: 'Cifra',
  publisher: 'Cifra',
  formatDetection: {
