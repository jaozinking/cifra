import { Product, ProductCategory, SalesDataPoint, PromoCode } from './types';

export const MOCK_PRODUCTS: Product[] = [
  {
    id: '1',
    title: 'Ultimate Freelance Notion Dashboard',
    description: 'Полная система управления проектами для фрилансеров. Включает CRM, трекер задач и финансовый учет.',
    priceRub: 1500,
  ...
  },
  {
    ...
    description: 'Пакет из 15 пресетов для Lightroom в стиле киберпанк. Идеально для ночной городской съемки.',
    priceRub: 890,
  ...
  },
  {
    ...
    description: 'Бойлерплейт для быстрого старта мобильных приложений. TypeScript, Expo, настроенный линтинг.',
    priceRub: 3500,
