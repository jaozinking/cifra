...
import { LayoutGrid, ShoppingBag, Settings, Search, Percent, User, Users } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-4 lg:gap-8">
            ...
            >
              <div className="w-8 h-8 bg-linear-to-tr from-violet-600 to-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-lg">C</div>
              <span className="hidden sm:inline text-xl font-bold text-white tracking-tight">Cifra</span>
            </div>
